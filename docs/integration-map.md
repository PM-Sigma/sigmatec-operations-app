...
Generated from 27 legacy modules, 109 island sources and 8 edge functions.
...
|---|---|---|---|
| `sigma.appInstall` | js/src/00-bridge.js:412 | `appInstall` → js/src/16-install.js:34 | app/src/islands/Settings.tsx:107 |
...
| `sigma.attExportExcel` | js/src/00-bridge.js:403 | `xlExportAttendanceCurrent` → js/src/21-excel-export.js:251 | app/src/islands/Attendance.tsx:341 |
| `sigma.attExportPdf` | js/src/00-bridge.js:402 | `downloadAttendancePDF` → js/src/04-attendance-daily.js:503 | app/src/islands/Attendance.tsx:338 |
| `sigma.attHolidays` | js/src/00-bridge.js:395 | `attHolidays` → js/src/04-attendance-daily.js:28 | app/src/islands/Attendance.tsx:54<br>app/src/islands/Calendar.tsx:87<br>app/src/islands/Gaps.tsx:79 |
| `sigma.attHolidaysLoad` | js/src/00-bridge.js:396 | `attLoadHolidays` → js/src/04-attendance-daily.js:31 | app/src/islands/Attendance.tsx:53<br>app/src/islands/Calendar.tsx:87<br>app/src/islands/Holidays.tsx:55 |
| `sigma.attPerson` | js/src/00-bridge.js:398 | `attPerson` → js/src/11-search-login.js:167 | app/src/islands/Attendance.tsx:209<br>app/src/islands/Attendance.tsx:249 |
| `sigma.attRefresh` | js/src/00-bridge.js:401 | `renderAttendanceReport` → js/src/04-attendance-daily.js:167 | app/src/islands/Attendance.tsx:265 |
| `sigma.attRows` | js/src/00-bridge.js:392 | `attRowsFor` → js/src/04-attendance-daily.js:92 | app/src/islands/Attendance.tsx:47<br>app/src/islands/Gaps.tsx:87 |
| `sigma.attSave` | js/src/00-bridge.js:384 | *(own logic)* | app/src/islands/Attendance.tsx:271 |
| `sigma.beginReLogin` | js/src/00-bridge.js:368 | *(own logic)* | app/src/components/UserChip.tsx:97 |
| `sigma.calAddEvent` | js/src/00-bridge.js:427 | `calAddEvent` → js/src/14-calendar.js:177 | **—** |
| `sigma.calFetchEvents` | js/src/00-bridge.js:426 | `calFetchEvents` → js/src/14-calendar.js:150 | app/src/islands/Calendar.tsx:92<br>app/src/islands/Presenter.tsx:69 |
| `sigma.calIslandMounted` | js/src/00-bridge.js:441 | *(own logic)* | app/src/islands/Calendar.tsx:1245 |
| `sigma.canInstall` | js/src/00-bridge.js:411 | `canInstall` → js/src/16-install.js:32 | app/src/islands/Settings.tsx:100 |
| `sigma.canSeeAttendance` | js/src/00-bridge.js:400 | `canSeeAttendance` → js/src/11-search-login.js:165 | **—** |
...
| `sigma.canUseEms` | js/src/00-bridge.js:459 | `canUseEms` → js/src/11-search-login.js:131 | app/src/islands/CommandBar.tsx:131 |
| `sigma.certFromVisit` | js/src/00-bridge.js:362 | `certFromVisit` → js/src/20-delivery-cert.js:701 | **—** |
| `sigma.certFromVisitForm` | js/src/00-bridge.js:361 | `certFromVisitForm` → js/src/20-delivery-cert.js:678 | app/src/components/home/CardActions.tsx:35<br>app/src/islands/Field.tsx:678 |
| `sigma.changeUser` | js/src/00-bridge.js:170 | `changeUser` → js/src/11-search-login.js:224 | app/src/components/UserChip.tsx:99 |
| `sigma.companyTasks` | js/src/00-bridge.js:468 | *(own logic)* | app/src/islands/Calendar.tsx:579 |
| `sigma.contactPhone` | js/src/00-bridge.js:465 | `contactPhone` → js/src/12-reports.js:18 | app/src/islands/Calendar.tsx:612 |
| `sigma.createTask` | js/src/00-bridge.js:254 | `emsWriteOrQueue` → js/src/13-ems.js:216 | app/src/components/home/InternalTasks.tsx:67<br>app/src/components/home/MeetingNotes.tsx:111<br>app/src/islands/MeetingReview.test.tsx:328<br>app/src/islands/MeetingReview.tsx:144<br>…+1 |
| `sigma.decorateCards` | js/src/00-bridge.js:244 | *(own logic)* | app/src/islands/Home.tsx:98 |
| `sigma.emsAddComment` | js/src/00-bridge.js:323 | *(own logic)* | app/src/islands/DayLog.tsx:333 |
| `sigma.emsApi` | js/src/00-bridge.js:199 | `emsApi` → js/src/12-reports.js:139 | app/src/components/home/HealthStrip.tsx:22<br>app/src/components/home/HealthStrip.tsx:24<br>app/src/lib/emsChain.ts:73<br>app/src/lib/emsChain.ts:80 |
...
| `sigma.emsCreateTask` | js/src/00-bridge.js:461 | `emsCreateTaskModal` → js/src/14-calendar.js:453 | app/src/islands/CommandBar.tsx:158 |
| `sigma.emsDisconnect` | js/src/00-bridge.js:462 | `emsDisconnect` → js/src/12-reports.js:110 | app/src/components/UserChip.tsx:95<br>app/src/islands/CommandBar.tsx:160 |
| `sigma.emsLabels` | js/src/00-bridge.js:218 | `emsLabels` → js/src/14-calendar.js:431 | app/src/lib/emsTasks.ts:23 |
| `sigma.emsPatchTask` | js/src/00-bridge.js:428 | *(own logic)* | **—** |
| `sigma.emsPatchTasks` | js/src/00-bridge.js:434 | *(own logic)* | app/src/islands/Calendar.tsx:983<br>app/src/islands/Calendar.tsx:995 |
| `sigma.emsSetStatus` | js/src/00-bridge.js:460 | `changeEmsStatus` → js/src/14-calendar.js:734 | app/src/islands/Calendar.tsx:597 |
...
| `sigma.ensurePass` | js/src/00-bridge.js:371 | *(own logic)* | **—** |
| `sigma.gapNag` | js/src/00-bridge.js:420 | `gapNag` → js/src/22-push.js:297 | app/src/islands/Gaps.tsx:181 |
| `sigma.getCurrentUser` | js/src/00-bridge.js:164 | `getCurrentUser` → js/src/11-search-login.js:120 | app/src/bridge.ts:342<br>app/src/components/home/CardActions.tsx:27<br>app/src/components/Nav.tsx:59<br>app/src/islands/Burns.tsx:70<br>…+7 |
| `sigma.getEmsSites` | js/src/00-bridge.js:220 | `getEmsSites` → js/src/14-calendar.js:364 | app/src/components/home/HealthStrip.tsx:25<br>app/src/lib/emsChain.ts:60 |
| `sigma.getLastVisit` | js/src/00-bridge.js:309 | `getLastVisit` → js/src/09-visits.js:239 | app/src/islands/Field.tsx:644 |
| `sigma.getRole` | js/src/00-bridge.js:165 | *(own logic)* | app/src/bridge.ts:343<br>app/src/islands/CommandBar.tsx:129<br>app/src/islands/Feedback.tsx:166<br>app/src/islands/Feedback.tsx:510<br>…+1 |
...
| `sigma.isEmsConnected` | js/src/00-bridge.js:200 | `isEmsConnected` → js/src/12-reports.js:56 | app/src/components/home/KibbutzSheet.tsx:95<br>app/src/islands/Settings.tsx:181 |
...
| `sigma.isInstalled` | js/src/00-bridge.js:410 | `isInstalled` → js/src/16-install.js:27 | app/src/islands/Settings.tsx:99 |
...
| `sigma.loadAllVisitsCombined` | js/src/00-bridge.js:359 | `loadAllVisitsCombined` → js/src/09-visits.js:73 | app/src/islands/Calendar.tsx:914<br>app/src/islands/Field.tsx:146<br>app/src/islands/Gaps.tsx:73<br>app/src/islands/Presenter.tsx:112 |
| `sigma.onLanding` | app/src/islands/Field.tsx:590 *(island)* | *(island-provided)* | **—** |
| `sigma.openActivity` | js/src/00-bridge.js:464 | `openActivityModal` → js/src/10-activity.js:6 | app/src/islands/Calendar.tsx:664 |
| `sigma.openCommandBar` | app/src/islands/CommandBar.tsx:280 *(island)* | *(island-provided)* | **—** |
| `sigma.openDeliveryCert` | js/src/00-bridge.js:360 | `openDeliveryCert` → js/src/20-delivery-cert.js:165 | app/src/islands/CommandBar.tsx:145 |
| `sigma.openKibbutzEmsTask` | js/src/00-bridge.js:224 | `openKibbutzEmsTask` → js/src/13-ems.js:324 | app/src/components/home/EmsTasks.test.tsx:107<br>app/src/components/home/EmsTasks.tsx:64<br>app/src/components/home/EmsTasks.tsx:65<br>app/src/components/home/MeetingNotes.tsx:179<br>…+5 |
...
| `sigma.openVisitQuick` | js/src/00-bridge.js:285 | *(own logic)* | app/src/components/home/CardActions.tsx:39<br>app/src/components/home/CardActions.tsx:45<br>app/src/components/Nav.tsx:62<br>app/src/components/Nav.tsx:64<br>…+10 |
| `sigma.openVisitsReport` | js/src/00-bridge.js:463 | `openVisitsToolsModal` → js/src/09-visits.js:1118 | app/src/islands/Calendar.tsx:663 |
| `sigma.passPending` | js/src/00-bridge.js:377 | *(own logic)* | **—** |
| `sigma.prefillOpenItems` | js/src/00-bridge.js:333 | *(own logic)* | app/src/islands/Field.tsx:667 |
| `sigma.productNames` | js/src/00-bridge.js:194 | *(own logic)* | app/src/islands/DayLog.tsx:57 |
| `sigma.pushDeviceCount` | js/src/00-bridge.js:418 | `pushDeviceCount` → js/src/22-push.js:131 | app/src/islands/Settings.tsx:174 |
| `sigma.pushEnable` | js/src/00-bridge.js:416 | `pushEnable` → js/src/22-push.js:106 | app/src/islands/Settings.tsx:135 |
| `sigma.pushState` | js/src/00-bridge.js:414 | `pushState` → js/src/22-push.js:97 | app/src/islands/Settings.tsx:120 |
| `sigma.pushTest` | js/src/00-bridge.js:417 | `pushTest` → js/src/22-push.js:119 | app/src/islands/Settings.tsx:158 |
| `sigma.remintOnce` | js/src/00-bridge.js:374 | *(own logic)* | **—** |
| `sigma.saveVisitFromData` | js/src/00-bridge.js:317 | *(own logic)* | app/src/islands/DayLog.tsx:325 |
| `sigma.sbAuthPass` | js/src/00-bridge.js:268 | *(own logic)* | **—** |
| `sigma.sbPass` | js/src/00-bridge.js:263 | *(own logic)* | app/src/islands/DayLog.tsx:100 |
| `sigma.sessionExpired` | js/src/00-bridge.js:367 | *(own logic)* | **—** |
| `sigma.setAttPerson` | js/src/00-bridge.js:399 | `setAttPerson` → js/src/11-search-login.js:168 | app/src/islands/Attendance.tsx:264 |
...
| `sigma.STAFF_PEOPLE` | js/src/00-bridge.js:479 | *(own logic)* | app/src/islands/CommandBar.tsx:49 |
| `sigma.staffSendMessage` | js/src/00-bridge.js:474 | *(own logic)* | app/src/islands/CommandBar.tsx:62 |
| `sigma.toast` | js/src/00-bridge.js:484 | *(own logic)* | app/src/components/UserChip.tsx:89<br>app/src/islands/CommandBar.tsx:64<br>app/src/islands/CommandBar.tsx:67<br>app/src/islands/CommandBar.tsx:215<br>…+3 |
| `sigma.track` | js/src/00-bridge.js:181 | *(own logic)* | **—** |
| `sigma.visitDraftDiscard` | js/src/00-bridge.js:358 | `visitDraftDiscard` → js/src/09-visits.js:599 | **—** |
| `sigma.visitDraftFor` | js/src/00-bridge.js:357 | `visitDraftFor` → js/src/09-visits.js:584 | app/src/components/home/CardActions.tsx:28<br>app/src/components/Nav.tsx:60<br>app/src/islands/Field.tsx:780<br>app/src/lib/visitDrafts.ts:61 |

Bridge entries no island calls today (legacy-side or reserved): `calAddEvent`, `canSeeAttendance`, `certFromVisit`, `emsPatchTask`, `ensurePass`, `kibbutzHasSite`, `passPending`, `remintOnce`, `sbAuthPass`, `sessionExpired`, `track`, `visitDraftDiscard`.
...
| `ems-cache-synced` | js/src/13-ems.js:90<br>js/src/14-calendar.js:584 | app/src/bridge.ts:361<br>app/src/components/home/EmsTasks.tsx:36<br>app/src/islands/Calendar.tsx:897<br>app/src/islands/Field.tsx:171<br>app/src/islands/Home.tsx:102<br>app/src/islands/Presenter.tsx:99 |
| `ems-queue-flushed` | js/src/13-ems.js:281 | app/src/components/home/MeetingNotes.tsx:51 |
...
| `session-expired` | js/src/00-bridge.js:56<br>app/src/lib/session.ts:126 | app/src/bridge.ts:363<br>app/src/components/ReLoginSheet.tsx:52<br>app/src/lib/session.test.ts:96 |
| `theme-changed` | app/src/lib/theme.ts:52 | app/src/components/ThemeToggle.tsx:12<br>app/src/components/ui/sonner.tsx:18 |
| `user-changed` | js/src/11-search-login.js:231<br>js/src/11-search-login.js:252<br>js/src/15-login-gate.js:202<br>js/src/15-login-gate.js:215<br>js/src/15-login-gate.js:337<br>…+1 | app/src/bridge.ts:362<br>app/src/islands/Attendance.tsx:249<br>app/src/islands/FeedbackInbox.tsx:228<br>app/src/islands/Field.tsx:150<br>app/src/islands/Usage.tsx:217<br>app/src/lib/currentPage.ts:27<br>…+2 |
...
| `visit-form-open` | js/src/02-init-attendance.js:13 | js/src/00-bridge.js:83<br>js/src/00-bridge.js:348<br>app/src/components/home/CardActions.tsx:38<br>app/src/islands/Field.tsx:681 |
...
|---|---|---|
| `#sigma-attendance` | :484 | app/src/islands/Attendance.tsx:470<br>app/src/main.tsx:182 |
| `#sigma-burns` | :287 | app/src/islands/Burns.tsx:87<br>app/src/main.tsx:145 |
| `#sigma-burns-modal` | :653 | app/src/main.tsx:145 |
| `#sigma-calendar` | :569 | app/src/islands/Calendar.tsx:1244<br>app/src/main.tsx:201 |
| `#sigma-ceo` | :1258 | **—** |
| `#sigma-command` | :1253 | app/src/islands/CommandBar.tsx:349<br>app/src/main.tsx:230 |
| `#sigma-daylog` | :1244 | app/src/islands/DayLog.tsx:435<br>app/src/main.tsx:319 |
| `#sigma-dev-presenter` | :1249 | app/src/islands/DevPresenter.tsx:492<br>app/src/main.tsx:408 |
| `#sigma-feedback` | :1235 | app/src/islands/Feedback.tsx:502<br>app/src/main.tsx:161 |
| `#sigma-feedback-inbox` | :1236 | app/src/islands/FeedbackInbox.tsx:331<br>app/src/main.tsx:166 |
| `#sigma-field` | :1234 | app/src/islands/Field.tsx:869<br>app/src/main.tsx:127 |
| `#sigma-gaps` | :1242 | app/src/islands/Gaps.tsx:274<br>app/src/main.tsx:265 |
| `#sigma-header-actions` | :220 | app/src/islands/HeaderActions.tsx:68<br>app/src/main.tsx:230 |
| `#sigma-health-modal` | :658 | app/src/main.tsx:154 |
| `#sigma-holidays` | :1238 | app/src/islands/Holidays.tsx:142<br>app/src/main.tsx:215 |
| `#sigma-home` | :290 | app/src/islands/Home.tsx:253<br>app/src/main.tsx:109 |
| `#sigma-import` | :1240 | app/src/islands/ImportNotes.tsx:365<br>app/src/main.tsx:449 |
| `#sigma-meeting-review` | :1252 | app/src/islands/MeetingReview.tsx:625 |
| `#sigma-modal-meetings` | :647 | app/src/main.tsx:136 |
| `#sigma-nav` | :1265 | app/src/main.tsx:75 |
| `#sigma-pm-today` | :1257 | app/src/islands/PmToday.tsx:27<br>app/src/main.tsx:117 |
| `#sigma-presenter` | :1246 | app/src/islands/Presenter.tsx:727<br>app/src/main.tsx:364 |
| `#sigma-refresh` | :1263 | app/src/components/PullToRefresh.tsx:175<br>app/src/main.tsx:91 |
| `#sigma-relogin` | :1260 | app/src/components/ReLoginSheet.tsx:99 |
| `#sigma-settings` | :1241 | app/src/islands/Settings.tsx:397<br>app/src/main.tsx:241 |
| `#sigma-toaster` | :1264 | app/src/main.tsx:74 |
| `#sigma-today` | :284 | app/src/islands/Field.tsx:870<br>app/src/main.tsx:127 |
| `#sigma-usage` | :1239 | app/src/islands/Usage.tsx:329<br>app/src/main.tsx:222 |
...
| `site_contacts` | db/site_contacts.sql | app/src/components/home/workTimerApi.ts:39<br>app/src/components/home/WorkTimerStopSheet.tsx:53<br>app/src/lib/emsChain.ts:90 |
...
| `dev-presenter` | `GitPullRequest` | app/src/main.tsx:432 |
...
| `field-journal` | `Notebook` | app/src/main.tsx:343 |
| `gaps` | `ClipboardList` | app/src/islands/Gaps.tsx:278 |
| `gaps` | `ClipboardList` | app/src/main.tsx:293 |
...
| `presenter` | `Presentation` | app/src/main.tsx:388 |
