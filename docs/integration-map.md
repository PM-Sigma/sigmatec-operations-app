...
Generated from 26 legacy modules, 195 island sources and 10 edge functions.
...
| `sigma.attApply` | js/src/00-bridge.js:521 | *(own logic)* | app/src/islands/Field.tsx:1365<br>app/src/lib/visitSave.ts:28<br>app/src/lib/visitSave.ts:28 |
...
| `sigma.attHolidays` | js/src/00-bridge.js:561 | `attHolidays` → js/src/04-attendance-daily.js:35 | app/src/islands/Attendance.tsx:65<br>app/src/islands/Calendar.tsx:106<br>app/src/islands/Gaps.tsx:96 |
| `sigma.attHolidaysLoad` | js/src/00-bridge.js:562 | `attLoadHolidays` → js/src/04-attendance-daily.js:38 | app/src/islands/Attendance.tsx:64<br>app/src/islands/Calendar.tsx:106<br>app/src/islands/Holidays.tsx:57 |
...
| `sigma.attRows` | js/src/00-bridge.js:558 | `attRowsFor` → js/src/04-attendance-daily.js:162 | app/src/islands/Attendance.tsx:58<br>app/src/islands/Calendar.tsx:136<br>app/src/islands/Gaps.tsx:106 |
...
| `sigma.calAddEvent` | js/src/00-bridge.js:593 | `calAddEvent` → js/src/14-calendar.js:177 | **—** |
...
| `sigma.certFromVisitForm` | js/src/00-bridge.js:509 | `certFromVisitForm` → js/src/20-delivery-cert.js:773 | app/src/islands/Field.tsx:2116 |
| `sigma.certIssuedForVisit` | js/src/00-bridge.js:504 | *(own logic)* | app/src/islands/Field.tsx:1184 |
...
| `sigma.emsAddComment` | js/src/00-bridge.js:460 | *(own logic)* | app/src/islands/DayLog.tsx:342 |
| `sigma.emsAfterWrite` | js/src/00-bridge.js:442 | `emsAfterWrite` → js/src/14-calendar.js:557 | app/src/lib/inventoryApi.ts:231<br>app/src/lib/inventoryApi.ts:411 |
...
| `sigma.emsCreateTask` | js/src/00-bridge.js:627 | `emsCreateTaskModal` → js/src/14-calendar.js:457 | **—** |
| `sigma.emsDisconnect` | js/src/00-bridge.js:628 | `emsDisconnect` → js/src/12-reports.js:95 | **—** |
| `sigma.emsLabels` | js/src/00-bridge.js:313 | `emsLabels` → js/src/14-calendar.js:435 | app/src/lib/emsTasks.ts:24 |
| `sigma.emsPatchTask` | js/src/00-bridge.js:594 | *(own logic)* | **—** |
| `sigma.emsPatchTasks` | js/src/00-bridge.js:600 | *(own logic)* | app/src/islands/Calendar.tsx:1597<br>app/src/islands/Calendar.tsx:1609<br>app/src/lib/calendarData.ts:52<br>app/src/lib/calendarData.ts:53 |
| `sigma.emsQueueLocalPush` | js/src/00-bridge.js:362 | `emsQueueLocalPush` → js/src/13-ems.js:243 | **—** |
| `sigma.emsSetStatus` | js/src/00-bridge.js:626 | `changeEmsStatus` → js/src/14-calendar.js:712 | app/src/islands/Calendar.tsx:989 |
...
| `sigma.gapNag` | js/src/00-bridge.js:586 | `gapNag` → js/src/22-push.js:337 | app/src/islands/Gaps.tsx:205 |
| `sigma.getCurrentUser` | js/src/00-bridge.js:259 | `getCurrentUser` → js/src/11-search-login.js:123 | app/src/bridge.ts:406<br>app/src/islands/Burns.tsx:49<br>app/src/islands/DayLog.tsx:487<br>app/src/islands/DevPresenter.tsx:730<br>…+11 |
...
| `sigma.getLastVisit` | js/src/00-bridge.js:419 | *(own logic)* | app/src/islands/Field.tsx:2074 |
| `sigma.getRole` | js/src/00-bridge.js:260 | *(own logic)* | app/src/bridge.ts:407<br>app/src/islands/Feedback.tsx:183<br>app/src/islands/Feedback.tsx:671<br>app/src/lib/landing.ts:111<br>…+1 |
...
| `sigma.loadAllVisitsCombined` | js/src/00-bridge.js:507 | `loadAllVisitsCombined` → js/src/09-visits.js:73 | app/src/islands/Calendar.tsx:1390<br>app/src/islands/Field.tsx:163<br>app/src/islands/Field.tsx:1224<br>app/src/islands/Gaps.tsx:90<br>…+4 |
...
| `sigma.openDeliveryCert` | js/src/00-bridge.js:508 | `openDeliveryCert` → js/src/20-delivery-cert.js:165 | app/src/islands/Field.tsx:1505<br>app/src/islands/Field.tsx:1605 |
...
| `sigma.poolStock` | js/src/00-bridge.js:429 | `poolStockMap` → js/src/08-inventory.js:11 | app/src/islands/Field.tsx:1417<br>app/src/islands/StockChange.tsx:58 |
| `sigma.prefillOpenItems` | js/src/00-bridge.js:470 | *(own logic)* | app/src/islands/Field.tsx:2102 |
| `sigma.productNames` | js/src/00-bridge.js:289 | *(own logic)* | app/src/islands/Field.tsx:1427<br>app/src/lib/daylogChain.ts:24 |
| `sigma.products` | js/src/00-bridge.js:431 | `getActiveProducts` → js/src/06-products.js:2 | app/src/islands/Field.tsx:1435<br>app/src/islands/InventoryStrip.tsx:43<br>app/src/islands/StockChange.tsx:62 |
| `sigma.pushDeviceCount` | js/src/00-bridge.js:584 | `pushDeviceCount` → js/src/22-push.js:158 | app/src/islands/Settings.tsx:198 |
| `sigma.pushEnable` | js/src/00-bridge.js:582 | `pushEnable` → js/src/22-push.js:133 | app/src/islands/Settings.tsx:157 |
| `sigma.pushNotify` | js/src/00-bridge.js:441 | `pushNotify` → js/src/22-push.js:171 | app/src/lib/inventoryApi.test.ts:192<br>app/src/lib/inventoryApi.ts:182<br>app/src/lib/inventoryApi.ts:238 |
| `sigma.pushState` | js/src/00-bridge.js:580 | `pushState` → js/src/22-push.js:124 | app/src/islands/Settings.tsx:142 |
| `sigma.pushTest` | js/src/00-bridge.js:583 | `pushTest` → js/src/22-push.js:146 | app/src/islands/Settings.tsx:173 |
| `sigma.refreshData` | js/src/00-bridge.js:438 | `refreshData` → js/src/10-activity.js:657 | app/src/islands/StockChange.tsx:153<br>app/src/lib/inventoryApi.ts:96 |
| `sigma.remintOnce` | js/src/00-bridge.js:540 | *(own logic)* | **—** |
| `sigma.saveVisitFromData` | js/src/00-bridge.js:454 | *(own logic)* | app/src/lib/visitSave.ts:25<br>app/src/lib/visitSave.ts:25 |
| `sigma.sbAuthPass` | js/src/00-bridge.js:381 | *(own logic)* | **—** |
| `sigma.sbPass` | js/src/00-bridge.js:376 | *(own logic)* | app/src/islands/FeedbackInbox.tsx:77<br>app/src/lib/daylogChain.ts:73<br>app/src/lib/devBoard.ts:30 |
...
| `sigma.STAFF_PEOPLE` | js/src/00-bridge.js:645 | *(own logic)* | app/src/islands/MessageSheet.tsx:39 |
| `sigma.staffSendMessage` | js/src/00-bridge.js:640 | *(own logic)* | app/src/islands/MessageSheet.tsx:60 |
| `sigma.toast` | js/src/00-bridge.js:650 | *(own logic)* | app/src/components/UserChip.tsx:83<br>app/src/islands/MessageSheet.tsx:62<br>app/src/islands/MessageSheet.tsx:65<br>app/src/islands/Usage.tsx:58<br>…+4 |
| `sigma.track` | js/src/00-bridge.js:276 | *(own logic)* | app/src/islands/Hours.tsx:248<br>app/src/lib/inventoryApi.test.ts:205 |
| `sigma.visitDraftDiscard` | js/src/00-bridge.js:495 | `visitDraftDiscard` → js/src/09-visits.js:743 | app/src/islands/Field.tsx:1354 |
| `sigma.visitDraftFor` | js/src/00-bridge.js:494 | `visitDraftFor` → js/src/09-visits.js:727 | app/src/islands/Field.tsx:1248<br>app/src/islands/Field.tsx:2238<br>app/src/lib/visitDrafts.ts:70<br>app/src/lib/visitDrafts.ts:88 |
| `sigma.visitDraftId` | js/src/00-bridge.js:502 | `visitDraftId` → js/src/09-visits.js:20 | app/src/islands/Field.tsx:1263 |
| `sigma.visitDraftPut` | js/src/00-bridge.js:499 | `visitDraftPut` → js/src/09-visits.js:886 | app/src/islands/Field.tsx:1166 |
| `sigma.visitReturnsRaw` | js/src/00-bridge.js:514 | *(own logic)* | app/src/islands/Field.tsx:1227 |
| `sigma.xlExportCerts` | js/src/00-bridge.js:446 | `xlExportCerts` → js/src/21-excel-export.js:308 | **—** |
| `sigma.xlExportKibbutz` | js/src/00-bridge.js:445 | `xlExportKibbutzXlsx` → js/src/21-excel-export.js:325 | **—** |
| `sigma.xlExportStock` | js/src/00-bridge.js:444 | `xlExportStockXlsx` → js/src/21-excel-export.js:322 | **—** |
...
| `ems-cache-synced` | js/src/13-ems.js:90<br>js/src/14-calendar.js:564 | app/src/bridge.ts:425<br>app/src/components/home/EmsTasks.tsx:36<br>app/src/islands/Calendar.tsx:1372<br>app/src/islands/Field.tsx:188<br>app/src/islands/MyTasks.tsx:158<br>app/src/islands/Presenter.tsx:223<br>…+1 |
...
| `user-changed` | js/src/11-search-login.js:229<br>js/src/11-search-login.js:250<br>js/src/15-login-gate.js:175<br>js/src/15-login-gate.js:270<br>js/src/15-login-gate.js:294<br>…+2 | app/src/bridge.ts:426<br>app/src/islands/Attendance.tsx:313<br>app/src/islands/FeedbackInbox.tsx:233<br>app/src/islands/Field.tsx:167<br>app/src/islands/Usage.tsx:218<br>app/src/lib/currentPage.ts:27<br>…+2 |
...
| `visit-form-open` | js/src/02-init-attendance.js:13 | js/src/00-bridge.js:158<br>js/src/00-bridge.js:485<br>app/src/islands/Field.tsx:2119 |
| `visit-saved` | js/src/09-visits.js:1183<br>js/src/09-visits.js:1376<br>app/src/lib/kibbutzVisits.test.tsx:48 | app/src/islands/Attendance.tsx:306<br>app/src/islands/Calendar.tsx:1373<br>app/src/islands/Field.tsx:166<br>app/src/islands/Field.tsx:2234<br>app/src/islands/Presenter.tsx:224<br>app/src/lib/kibbutzVisits.ts:14<br>…+4 |
...
| `#sigma-today` | :292 | app/src/islands/Field.tsx:2347<br>app/src/main.tsx:158 |
...
| `day_plans` | db/day_plans.sql | app/src/islands/Calendar.tsx:1505<br>app/src/islands/Field.tsx:111<br>app/src/islands/Gaps.tsx:83<br>…+2 |
