...
STATUS: ✅ SHIPPED (2.11 at noon, 2.12 in the evening) — open: E1-push (server push while the phone is closed), K2 remainder (see `docs/reports/2026-09-22-copy-sweep.md`). D13 resolved by data ruling (new = דגניה ב · עין דור · ניר עציון).
